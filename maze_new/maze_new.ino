...
int ServoYHomePos = 88;

int ServoXPos;
int ServoYPos;

int servoStep;  // degrees
int servoDelay;
...
unsigned long int durations[] = {90000, 10000};  // Time limits for each level
unsigned int start_time;
unsigned long int time_lim;
...
void loop() {
  ...
  servoDelay = round(100/servoStep);
  moveServos();
